...
<html>
	<head>
		...
		<title>Decomposable Models</title>
	...
	<center>
		<table class=mpg><tr><td style="border: 0px solid #FFFFFF;">
			...
			<table class="title" cellpadding="20">
				<tr><td>
					<center><h1>Which Decomposable 3D Model Would You Like To View?</h1></center>
				</td></tr>
				<tr>
					<td><center>
							<table class=wrt>
								<tr>
									...
									<td class=wrt><a class=wrt href="http://web-students.armstrong.edu/~lf03747/X3dWebProject-master-test/volume.php">Volume</a></td>
								</tr>
							</table>
					</td></center>
				</tr>
